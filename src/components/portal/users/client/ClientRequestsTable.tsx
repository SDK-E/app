...
import type { ClientRequestRow } from "@/lib/users";
            ...
            <TR key={row.id}>
              ...
              <TD>
                <div className="flex items-start gap-2">
                  <UserActionForm
                    action={approveAccessRequestAction.bind(null, locale, companyId)}
                    label={t("approve")}
                    variant="default"
                  >
                  ...
                  <UserActionForm
                    action={declineAccessRequestAction.bind(null, locale, companyId)}
                    label={t("decline")}

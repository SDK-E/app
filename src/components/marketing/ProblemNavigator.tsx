        ...
        {items.map((item) => (
          <li key={item.number} className="border-b border-line">
            ...
            >
              ...
              <span className="max-w-[48ch] text-body text-muted-foreground">
                {item.copy}
              </span>
              <span className="text-h3 transition-transform group-hover:translate-x-1 motion-reduce:transition-none" aria-hidden>
                →
              </span>
            </Link>
          </li>

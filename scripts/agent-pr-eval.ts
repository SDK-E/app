...
const HIGH_BLAST_RADIUS: { pattern: RegExp; reason: string }[] = [
  { pattern: /^src\/lib\/authorization\.ts$/, reason: "authorization" },
  { pattern: /^src\/lib\/auth\.ts$/, reason: "auth" },
  { pattern: /^src\/lib\/identity.*\.ts$/, reason: "identity" },
  { pattern: /^prisma\/schema\.prisma$/, reason: "Prisma schema" },
  { pattern: /^prisma\/migrations\//, reason: "migrations" },
  { pattern: /^src\/proxy\.ts$/, reason: "proxy" },
  { pattern: /^src\/middleware\.ts$/, reason: "middleware" },
  { pattern: /^src\/locales\//, reason: "locales" },
